			...
			<div class="auth-box bg-dark border-top border-secondary">
				<div id="loginform">
					...
					<div class="text-center p-t-20 p-b-20">
						<span class="db"><img src="<?= base_url('assets/images'); ?>/logo/pgri.png" alt="logo" width="100px" /></span>
					</div>
					<!-- Form -->
					<form class="form-horizontal m-t-20" id="loginform" action="<?= base_url('index.php/auth/login_admin'); ?>" method="post">
