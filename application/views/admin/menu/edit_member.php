        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            <?= form_open('admin/ubahMember', '', ['id' => $member->id]); ?>
                            <div class="form-group row">
                                <label for="name" class="col-sm-3 control-label col-form-label">Email</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="email" id="email" placeholder="" value="<?= $member->email; ?>" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <button type="submit" class="offset-3 btn btn-primary">Simpan</button>
                                </div>
                            </div>
                            <?= form_close(); ?>
                        </div>
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <?= form_open_multipart('admin/up_photo', '', ['id' => $member->id]); ?>
