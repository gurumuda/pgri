...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="<?= base_url('index.php/dashboard/print_all'); ?>" target="_blank" class="btn btn-primary">Cetak Formulir</a>
                    <a href="<?= base_url('index.php/admin/export_excel'); ?>" class="btn btn-success">Download Data Excel</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($members as $member) : ?>
                                    <tr>
                                        ...
                                        <td nowrap>
                                            <button id="tombol-hapus-member" data-id="<?= $member->id; ?>" class="btn badge badge-danger" data-toggle="modal" data-target="#Modal2">Hapus</button>
                                            ...
                                            <button id="tombol-detail-member" data-id="<?= $member->id; ?>" class="btn badge badge-info" data-toggle="modal" data-target="#Modal1">Detail</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
